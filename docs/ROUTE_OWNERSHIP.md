...
| API endpoints | `POST /api/agent/devices/register`, `POST /api/agent/consents`, `POST /api/agent/heartbeat`, `POST /api/agent/diagnosis-chat`, `POST /api/agent/log-uploads`, `POST /api/agent-logs/upload`, `GET /api/agent-logs/{id}`, `POST /api/as-tickets`, `GET /api/as-tickets/{id}`, `GET /api/support/chat-sessions/current`, `GET /api/support/chat-sessions/{id}`, `POST /api/support/chat-sessions/{id}/messages`, `GET /api/admin/support/chat-sessions`, `GET /api/admin/support/chat-sessions/{id}`, `POST /api/admin/support/chat-sessions/{id}/messages`, `GET /api/admin/as-tickets`, `GET /api/admin/as-tickets/{id}`, `PATCH /api/admin/as-tickets/{id}`, `WS /ws/support-chat` |
...
| `POST /api/agent/diagnosis-chat` | 4번 | 3번, 5번 |
