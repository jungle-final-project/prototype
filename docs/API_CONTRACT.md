...
| `POST` | `/api/recommendation-events/bulk/async` | USER | 3번 | `{ "events": [{ "eventType": "IMPRESSION", "sourceSurface": "HOME_RECOMMENDED_PARTS", "recommendationId": "home-part-1", "partId": "0e9f3b8b-8c83-4d9a-9f7d-1f2b4dfb8a11", "category": "GPU", "rankPosition": 0, "idempotencyKey": "home-impression-home-part-1" }] }` | `{ "accepted": true, "queued": 1 }` | `recommendation_events`(async worker), RabbitMQ `buildgraph.recommendation.events` |
