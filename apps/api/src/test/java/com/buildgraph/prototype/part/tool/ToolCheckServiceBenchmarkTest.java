...
class ToolCheckServiceBenchmarkTest {
    ...
    void performanceToolUsesLatestBenchmarkSummariesWhenAvailable() {
        ...
        List<Map<String, Object>> results = service.checkBuild(List.of(
                new ToolBuildPart(1L, "10000000-0000-4000-8000-000000000001", "CPU", "Ryzen 9", "AMD", 800000, Map.of("socket", "AM5")),
                new ToolBuildPart(2L, "10000000-0000-4000-8000-000000000002", "GPU", "RTX 5080", "NVIDIA", 2300000, Map.of("vramGb", 16, "lengthMm", 340, "requiredSystemPowerW", 850)),
                new ToolBuildPart(3L, "10000000-0000-4000-8000-000000000003", "PSU", "850W Gold", "FSP", 150000, Map.of("capacityW", 1000)),
                new ToolBuildPart(4L, "10000000-0000-4000-8000-000000000004", "CASE", "Airflow Case", "Fractal", 200000, Map.of("maxGpuLengthMm", 380, "maxCpuCoolerHeightMm", 180))
        ), 4000000);
    ...
    void performanceToolIncludesGameFpsEvidenceWhenGameContextMatches() {
        ...
        Map<String, Object> result = service.checkTool("performance", Map.of(
                "partIds", List.of("10000000-0000-4000-8000-000000000001", "10000000-0000-4000-8000-000000000002"),
    ...
    void sizeToolFailsWhenCaseClearanceIsExceeded() {
        ...
        List<Map<String, Object>> results = service.checkBuild(List.of(
                new ToolBuildPart(1L, "10000000-0000-4000-8000-000000000002", "GPU", "Oversized GPU", "BuildGraph", 2_000_000, Map.of("lengthMm", 360)),
                new ToolBuildPart(2L, "10000000-0000-4000-8000-000000000004", "CASE", "Compact Case", "BuildGraph", 150_000, Map.of(
                        "maxGpuLengthMm", 330,
    ...
    void powerToolWarnsInsteadOfFailingWhenPsuMeetsVendorRecommendation() {
        ...
        List<Map<String, Object>> results = service.checkBuild(List.of(
                new ToolBuildPart(1L, "10000000-0000-4000-8000-000000000001", "CPU", "Ryzen 7", "AMD", 400_000, Map.of("socket", "AM5", "wattage", 200)),
                new ToolBuildPart(2L, "10000000-0000-4000-8000-000000000002", "GPU", "RTX 5070", "NVIDIA", 900_000, Map.of("wattage", 480, "requiredSystemPowerW", 750, "lengthMm", 300)),
                new ToolBuildPart(3L, "10000000-0000-4000-8000-000000000003", "PSU", "750W Gold", "FSP", 150_000, Map.of("capacityW", 750)),
                new ToolBuildPart(4L, "10000000-0000-4000-8000-000000000004", "CASE", "Airflow Case", "Fractal", 160_000, Map.of("maxGpuLengthMm", 360, "maxCpuCoolerHeightMm", 180))
        ), 3_000_000);
